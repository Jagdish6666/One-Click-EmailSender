package com.project.certificates.participant.service;
...
import com.project.certificates.participant.repository.ParticipantRepository;
        ...
        try (java.io.InputStream is = file.getInputStream();
            ...
            for (int i = 1; i <= sheet.getLastRowNum(); i++) {
                ...
                if (name != null && email != null && !name.isBlank() && !email.isBlank()) {
                    ...
                    if (event.isBlank()) event = "Unknown Event";
