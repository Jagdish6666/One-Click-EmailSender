package com.project.certificates.certificate.util;
...
import com.project.certificates.certificate.repository.CertificateTemplateRepository;
...
public class CertificatePdfGenerator {
    ...
    public byte[] generate(ParticipantResponse participant) {
    ...
    private byte[] generateFromTemplate(ParticipantResponse participant, CertificateTemplate template) throws Exception {
    ...
    public byte[] generateDefault(ParticipantResponse participant) {
        try (ByteArrayOutputStream out = new ByteArrayOutputStream()) {
